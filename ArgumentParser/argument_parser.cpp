...
ArgumentParser::ArgumentParser(int argc, char **argv) {
    ...
    this->description = new boost_arg::options_description{CONFIG_OPTIONS_DESCRIPTION};
    this->argc = argc;
    this->argv = argv;
...
boost_arg::variables_map ArgumentParser::GetVarMap(){
    ...
    boost_arg::store(boost_arg::parse_command_line(argc, argv, *description), VarMap);
