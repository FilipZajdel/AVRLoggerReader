...
#define CONFIG_ARGUMENTS \
  "help", "device", "baud", "file", "port", "ip", "timestamp", "screen_off"
...
#define CONFIG_ARGS_OPTIONS                                                    \
  ("help,h", "Help")("device,d", boost::program_options::value<std::string>(), \
                     "Serial port device")(                                    \
      "baud,b", boost::program_options::value<int>(), "Baudrate")(             \
      "file,f", boost::program_options::value<std::string>(),                  \
      "Save data to csv file")("port,p",                                       \
                               boost::program_options::value<std::string>(),   \
                               "Send data to this tcp port")(                  \
      "ip,i", boost::program_options::value<std::string>(),                    \
      "Send data to this ip")("timestamp,t",                                   \
                              "Attach timestamp to each sample")(              \
